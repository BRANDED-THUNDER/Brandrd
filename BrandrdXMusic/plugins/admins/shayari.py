...
async def mentionall(client, message):
    ...
    if message.chat.type == ChatType.PRIVATE:
        return await message.reply(
            "<b><blockquote>🚫 𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐎𝐧𝐥𝐲 𝐅𝐨𝐫 𝐆𝐫𝐨𝐮𝐩𝐬.</blockquote></b>",
        )
    ...
    if not is_admin:
        return await message.reply(
            "<b><blockquote>🚫 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐀𝐧 𝐀𝐝𝐦𝐢𝐧 𝐁𝐚𝐛𝐲 😏\n\n"
            "👑 𝐎𝐧𝐥𝐲 𝐀𝐝𝐦𝐢𝐧𝐬 𝐂𝐚𝐧 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬.</blockquote></b>",
        )

    if message.reply_to_message and message.text:
        return await message.reply(
            "<b><blockquote>⚠️ /shayaril\n\n"
            "📝 𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬 / 𝐑𝐞𝐩𝐥𝐲 𝐀𝐧𝐲 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐍𝐞𝐱𝐭 𝐓𝐢𝐦𝐞.</blockquote></b>",
        )
    ...
    if chat_id in spam_chats:
        return await message.reply(
            "<b><blockquote>⏳ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐀𝐭 𝐅𝐢𝐫𝐬𝐭 𝐒𝐭𝐨𝐩 𝐓𝐡𝐞 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 𝐏𝐫𝐨𝐜𝐞𝐬𝐬...</blockquote></b>",
        )
...
@app.on_message(
    filters.command(["cancelshayari", "shayarioff"])
)
async def cancel_spam(client, message):

    if message.chat.id not in spam_chats:
        return await message.reply(
            "<b><blockquote>⚠️ 𝐂𝐮𝐫𝐫𝐞𝐧𝐭𝐥𝐲 𝐈'𝐦 𝐍𝐨𝐭 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 𝐀𝐧𝐲 𝐒𝐡𝐚𝐲𝐚𝐫𝐢 𝐏𝐫𝐨𝐜𝐞𝐬𝐬.</blockquote></b>",
        )
    ...
    if not is_admin:
        return await message.reply(
            "<b><blockquote>🚫 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐀𝐧 𝐀𝐝𝐦𝐢𝐧 𝐁𝐚𝐛𝐲 😏\n\n"
            "👑 𝐎𝐧𝐥𝐲 𝐀𝐝𝐦𝐢𝐧𝐬 𝐂𝐚𝐧 𝐓𝐚𝐠 𝐌𝐞𝐦𝐛𝐞𝐫𝐬.</blockquote></b>",
        )
        ...
        return await message.reply(
            "<b><blockquote>🛑 𝐁𝐑𝐀𝐍𝐃𝐄𝐃 𝐒𝐇𝐀𝐘𝐀𝐑𝐈 𝐏𝐑𝐎𝐂𝐄𝐒𝐒 𝐒𝐓𝐎𝐏𝐏𝐄𝐃 💗</blockquote></b>",
        )
