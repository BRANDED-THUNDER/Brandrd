...
async def mentionall(client, message):
    ...
    if not is_admin:
        return await message.reply(
            "<b><blockquote>"
            "🚫 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐀𝐧 𝐀𝐝𝐦𝐢𝐧 𝐁𝐚𝐛𝐲.\n\n"
            "👑 𝐎𝐧𝐥𝐲 𝐀𝐝𝐦𝐢𝐧𝐬 𝐂𝐚𝐧 𝐓𝐚𝐠 𝐌𝐞𝐦𝐛𝐞𝐫𝐬."
            "</blockquote></b>",
        )
    ...
    if message.reply_to_message and message.text:
        return await message.reply(
            "<b><blockquote>"
            "⚠️ /tagall 𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬:\n\n"
            "➻ /tagall 𝐇𝐞𝐥𝐥𝐨 𝐅𝐫𝐢𝐞𝐧𝐝𝐬\n\n"
            "💡 𝐎𝐫 𝐑𝐞𝐩𝐥𝐲 𝐓𝐨 𝐀𝐧𝐲 𝐌𝐞𝐬𝐬𝐚𝐠𝐞."
            "</blockquote></b>",
        )
    ...
    if chat_id in spam_chats:
        return await message.reply(
            "<b><blockquote>"
            "⏳ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐅𝐢𝐫𝐬𝐭 𝐒𝐭𝐨𝐩 𝐓𝐡𝐞 𝐂𝐮𝐫𝐫𝐞𝐧𝐭 𝐓𝐚𝐠 𝐀𝐥𝐥 𝐏𝐫𝐨𝐜𝐞𝐬𝐬..."
            "</blockquote></b>",
        )
        ...
        async for usr in client.get_chat_members(chat_id):
            ...
            if usrnum == 1:
                ...
                if mode == "text_on_cmd":
                    ...
                    mention = (
                        f"<a href='tg://user?id={usr.user.id}'>"
...
async def cancel_spam(client, message):
    ...
    if chat_id not in spam_chats:
        return await message.reply(
            "<b><blockquote>"
            "ℹ️ 𝐂𝐮𝐫𝐫𝐞𝐧𝐭𝐥𝐲 𝐈'𝐦 𝐍𝐨𝐭 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 𝐀𝐧𝐲 𝐓𝐚𝐠 𝐏𝐫𝐨𝐜𝐞𝐬𝐬."
            "</blockquote></b>",
        )
    ...
    return await message.reply(
        ...
        "🌷 𝐁𝐑𝐀𝐍𝐃𝐄𝐃 𝐓𝐀𝐆 𝐀𝐋𝐋\n\n"
        "🛑 𝐏𝐑𝐎𝐂𝐄𝐒𝐒 𝐒𝐓𝐎𝐏𝐏𝐄𝐃\n\n"
        "✨ 𝐀𝐥𝐥 𝐓𝐚𝐠𝐠𝐢𝐧𝐠 𝐀𝐜𝐭𝐢𝐯𝐢𝐭𝐲 𝐇𝐚𝐬 𝐁𝐞𝐞𝐧 𝐒𝐭𝐨𝐩𝐩𝐞𝐝."
        "</blockquote></b>",
    )
